    ...
    <body>
        ...
        <main class="conteudo-principal">
            <div class="container-main">
                <div class="div-main">
                    <img class="img" src="img/funcionario1.png">
                    <h1 class="titulo-form">O funcionário foi alterado com sucesso!</h1>
                    ...
                    <div class="div-a">
                        ...
                        <a class="botao-a" href="home.jsp">Ir para página Home</a>
                    </div>
                </div>
