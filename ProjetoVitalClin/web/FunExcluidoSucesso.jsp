<%-- 
    Document   : FunExcluidoSucesso
    Created on : 03/06/2018, 00:14:24
    Author     : bruno
--%>
    ...
    <body>
        ...
        <main class="conteudo-principal">
            <div class="container-main">
                <div class="div-main">
                    <img class="img" src="img/delete1.png">
                    <h1 class="titulo-form">O funcionário foi excluido com sucesso!</h1>

                    <div class="div-a">
                        <a class="botao-a" href="ControleFuncionario?acao=Listar">Voltar</a>
                        <a class="botao-a" href="home.jsp">Ir para home</a>
                    </div>
                </div>
